...
- 🛠️ **Current Focus:** Exploring hardware vulnerabilities, network automation, and digital forensics.
- 🎯 **My Goal:** To evolve my technical skills daily, preparing to tackle complex challenges in defensive security.
- 🚀 **Philosophy:** "Learn by doing". Every repository here represents a milestone in my specialization journey.

---

## 📂 Featured Labs & Projects / Laboratorios y Proyectos

* **[🐍 Python4Cyber]**(./) Building custom security tools and automation scripts for network reconnaissance and auditing.
